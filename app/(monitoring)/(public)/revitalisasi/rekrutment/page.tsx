...
import { HardHatIcon, ImageIcon } from "lucide-react";
...
export default function RevitalisasiRecruitmentPage() {
  return (
    <div className="mx-auto max-w-6xl space-y-8 px-4 md:px-0">
      {/* Bagian Header */}
      <h1 className="text-lg font-semibold">
        Progres Perekrutan Tenaga Kerja (Revitalisasi)
      </h1>
...
function RecruitmentTimelineSection() {
  ...
  return (
    <div className="mb-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
      {/* Kolom Timeline */}
