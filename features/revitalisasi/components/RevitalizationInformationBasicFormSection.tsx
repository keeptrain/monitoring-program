...
interface RevitalizationInformationBasicFormSectionProps {
  form: UseFormReturn<
    RevitalizationReportFormInput,
    undefined,
    RevitalizationReportFormValues
...
export default function RevitalizationInformationBasicFormSection({
  form,
  isEdit,
}: RevitalizationInformationBasicFormSectionProps) {
  return (
