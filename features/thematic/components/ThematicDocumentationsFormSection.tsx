...
export default function ThematicDocumentationsFormSection({
  form,
}: ThematicFormProps) {
  ...
  const getStoredPreviewUrl = (savedPath?: string): string | undefined => {
    ...
    if (match && ["demo", "priority_program", "thematic"].includes(match[1])) {
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <Field>
                  ...
                  {beforePreviewSrc && (
                    <div className="border-border bg-muted/20 relative mt-2 max-w-fit overflow-hidden border">
