  ...
  return (
    <div className="space-y-6">
      ...
      <Field>
        ...
        <div className="relative aspect-video w-full bg-neutral-100 border-2 border-dashed border-neutral-300 flex flex-col items-center justify-center overflow-hidden cursor-crosshair hover:bg-neutral-200 transition-colors">
