...
-- Columns included: location_id, status, kusuka_number, name, progress_percent, commodity, land_area, production, total_admin, distribution_amount, sppg_partner, s_curve_path
